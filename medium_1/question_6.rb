...
# Use a method/operator that is more explicit and mutates the caller. The example I use is the .concat method but you
# can also use the << operator to let other programmers know that you are modifying the original string.